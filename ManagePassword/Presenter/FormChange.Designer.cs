namespace ManagePassword
{
    partial class FormChange
    {
        ...
        private void InitializeComponent()
        {
			...
			this.showPass = new System.Windows.Forms.RadioButton();
			this.SuspendLayout();
			// 
			// tbChangeService
			// 
			...
			// showPass
			// 
			this.showPass.AutoCheck = false;
			this.showPass.AutoSize = true;
			this.showPass.Location = new System.Drawing.Point(124, 90);
		...
		private System.Windows.Forms.RadioButton showPass;
	}
}